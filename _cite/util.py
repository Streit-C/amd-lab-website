...
def normalize_for_comparison(name):
    # Remove periods, convert to ascii, strip spaces, lowercase all
    name = unicodedata.normalize('NFKC', name)  # Fix unicode punctuation
    name = re.sub(r'[\.\uFF0E]', '', name)  # Remove periods (including fullwidth ·)
